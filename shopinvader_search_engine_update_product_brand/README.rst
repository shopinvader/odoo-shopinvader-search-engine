...
``shopinvader_search_engine_product_brand`` modules to mark the
information exported to the search engine as to be recomputed when the
brand of a product are updated.
...
When you update the product brand associated to a product and this
information is exposed by the search engine, you expect to see your
