...
``shopinvader_product_brand_tag`` and
``shopinvader_search_engine_update_product_brand`` modules to mark the
information exported to the search engine as to be recomputed when the
tag of a product brand is updated.
...
When you update the tag associated to a product brand and this
information is exposed by the search engine on the product and or on a
product brand index, you expect to see your changes applied into the
